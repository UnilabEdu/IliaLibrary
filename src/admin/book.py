...
class BookView(ModelView):
    ...
    column_labels = {"title": "სათაური", "media_type": "მედიის ტიპი", "cover_image": "წიგნის ყდის ფოტო", "annotation": "ანოტაცია", "volume_name": "ტომის სახელი", "volume_number": "ტომის ნომერი", "view_count": "ნახვების რაოდენობა", "edition": "გამოცემა", "copies" : "ტირაჟი", 
                      "publish_location": "გამოცემის ადგილი", "publish_year": "გამოცემის წელი",  "page_count": "გვერდების რაოდენობა", "book_height": "სიმაღლე სმ-ებში", "additional_information": "დამატებითი ტექსტური ინფორმაცია", 
                      "book_file": "pdf-ის ლინკი", "created_at": "დამატების თარიღი", "publisher" : "გამომცემლობის სახელი", "collections" : "კოლექციები", "series" : "სერიის/ების სახელი", "theme" : "თემატიკის/ების სახელი", "book_content" : "სარჩევი", "author" : "რედაქტორი"}

    column_exclude_list = ["id", "media_type", "cover_image", "annotation", "volume_number", "topic", "edition", "publish_location", "publish_amount", "page_count", "book_height", "additional_information"]

    column_list = ["volume_name", "title", "theme", "series",  "publisher", "publish_year", "book_file", "view_count", "created_at"]

    form_columns = ["media_type",  "title", "cover_image", "book_file", "annotation", "theme",  "volume_name", "volume_number", "series", "book_content", "edition", "publish_location", "publisher", "publish_year", "copies",  "author", "page_count", "book_height", "additional_information",  "collections" ]
